...
const ToggleGroupContext = React.createContext<string | undefined>(undefined);
...
>(({ className, ...props }, ref) => (
  <ToggleGroupPrimitive.Root
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-lg border border-input bg-background text-muted-foreground shadow-sm",
      className,
    )}
    {...props}
    data-oid="ah_zg0z"
