...
export default function FieldSuggestions({
  ...
  return (
    <Card className="mt-4" data-oid="r83w3j2">
      <CardHeader className="pb-3" data-oid="79ehsgo">
        <CardTitle
          className="flex items-center justify-between text-sm"
          data-oid="mb7:u1d"
        >
          <div className="flex items-center gap-2" data-oid="q:v7w-1">
            <Lightbulb className="h-4 w-4 text-yellow-500" data-oid="sc6nq5v" />
            智慧建議
          </div>
          {suggestion && (
            <div className="flex items-center gap-2" data-oid="dh.vhcg">
              <TrendingUp
                className="h-3 w-3 text-green-500"
                data-oid="42guk67"
              />
              <span className="text-xs text-gray-500" data-oid=".wz_ues">
      ...
      <CardContent className="space-y-3" data-oid="9gft6ur">
        {isLoading && (
          <div
          ...
          >
            <div
              ...
              data-oid=".h-mfcp"
            ></div>
            <span className="ml-2 text-sm text-gray-600" data-oid="r502kis">
              分析中...
            </span>
          </div>
        )}
        ...
        {suggestion && !isLoading && (
          <div className="space-y-3" data-oid="vj0yfeq">
            {/* 主要建議 */}
            <div
            ...
            >
              <div
                ...
                data-oid="f.:rb:e"
              >
                <div className="flex-1" data-oid="5p84c1t">
                  <div
                    className="flex items-center gap-2 mb-1"
                    data-oid="54zk9t."
                  >
                    <Badge
                      className={getFieldTypeColor(suggestion.fieldType)}
                      data-oid="wf-gfbi"
                    >
                  ...
                  <p className="text-sm text-gray-600 mb-2" data-oid="26e320l">
                    {suggestion.reasoning}
                  </p>
                  {field.fieldType === suggestion.fieldType ? (
                    <p className="text-xs text-green-600" data-oid="qamz25l">
                      ✓ 已應用此建議
                    </p>
                  ) : (
                    <p className="text-xs text-blue-600" data-oid="x.vm_4n">
                      建議將欄位類型改為此選項
                    </p>
                  )}
                </div>
                <div className="flex gap-1 ml-2" data-oid="xwe3h0b">
                  {field.fieldType !== suggestion.fieldType && (
                    <Button
                      ...
                      data-oid="o-0e-.x"
                    >
                      <Check className="h-3 w-3" data-oid="5k7s24y" />
                    </Button>
                  )}
                  <Button
                    ...
                    data-oid="p8_hvpt"
                  >
                    <X className="h-3 w-3" data-oid="4sk4o3h" />
                  </Button>
                </div>
              </div>
            </div>
            ...
            {suggestion.alternatives.length > 0 && (
              <>
                <div
                  ...
                  data-oid=":.8_wxo"
                />
                <div data-oid="e8n03ee">
                  <p className="text-xs text-gray-500 mb-2" data-oid="q2w5q6e">
                    其他建議選項:
                  </p>
                  <div className="flex flex-wrap gap-2" data-oid="838hvl6">
                    {suggestion.alternatives
                      ...
                      .map((alt: SuggestionAlternative, index: number) => (
                        ...
                        >
                          ...
                          <span className="text-gray-500" data-oid="o9xgemh">
        ...
        {!suggestion && !isLoading && field.name.trim() && (
          <div className="text-center py-4" data-oid="8q01spp">
            <p className="text-sm text-gray-500 mb-2" data-oid="_fusmhw">
              沒有可用的建議
            </p>
            <Button
              size="sm"
              ...
              data-oid="bkucrq."
            >
              <RotateCcw className="h-3 w-3 mr-1" data-oid="4pc47-t" />
              重新分析
            </Button>
          </div>
        )}
        ...
        {process.env.NODE_ENV === "development" && (
          <>
            <div
              ...
              data-oid=".3-j8bm"
            />
            <div className="text-xs text-gray-400" data-oid="ui0yq6-">
              <p data-oid="l4u-gz9">
                學習數據:{" "}
